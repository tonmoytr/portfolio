...
const projects = [
  ...
  },
  {
    ...
    description: "A collaborative Kanban board application with real-time updates.",
    image: "/images/2.avif",
  ...
  },
  {
    ...
    description: "SaaS application that generates marketing copy using OpenAI API.",
    image: "/images/3.avif",
  ...
  },
  {
    ...
    image: "/images/1.avif", // Reusing image 1 for demo purposes
          ...
          <div className="flex flex-col gap-4 mb-6">
            <div className="flex justify-between items-start w-full">
              ...
              <div className="flex gap-3">
                <a href={project.github} className="w-10 h-10 rounded-full bg-[var(--background)] border border-[var(--border)] flex items-center justify-center hover:bg-[var(--accent)] hover:border-transparent hover:text-white transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
                </a>
                <a href={project.live} className="w-10 h-10 rounded-full bg-[var(--accent)] text-white flex items-center justify-center hover:bg-[var(--accent-hover)] hover:-translate-y-1 transition-all duration-300 shadow-lg shadow-[rgba(var(--accent-rgb),0.3)]">
          ...
          <div className="flex flex-col gap-6 items-start">
            ...
            <div className="flex flex-wrap gap-2 w-full justify-start">
              {project.tags.map((tag: string, i: number) => (
                <span key={i} className="px-3 py-1 bg-[var(--background)] rounded-full text-[10px] font-semibold tracking-wider uppercase border border-[var(--border)] text-[var(--foreground)]">
                  {tag}
                </span>
              ))}
            </div>
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          ...
          <p className="text-[var(--muted)] max-w-sm text-lg">
            A showcase of my latest engineering endeavors, combining aesthetics with robust architecture.
          </p>
        </motion.div>
